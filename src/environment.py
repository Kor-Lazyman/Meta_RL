...
class Sales:
    def __init__(self, env, item_id, delivery_cost, setup_cost, shortage, due_date,Dist_info):
...
def create_env(I, P, daily_events,Dist_info):
    ...
    sales = Sales(simpy_env, customer.item_id,
                  I[0]["DELIVERY_COST"], I[0]["SETUP_COST_PRO"], I[0]["SHORTAGE_COST_PRO"], I[0]["DUE_DATE"],Dist_info)
    productionList = []
    for i in P.keys():
